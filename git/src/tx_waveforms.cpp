...
int UHD_SAFE_MAIN(int argc, char* argv[])
{
    ...
    desc.add_options()
        ("help", "help message")
        ("args", po::value<std::string>(&args)->default_value("name=MyB200"), "single uhd device address args")
        ...
        ("ampl", po::value<float>(&ampl)->default_value(float(0.5)), "amplitude of the waveform [0 to 0.7]")
        ("gain", po::value<double>(&gain)->default_value(73.2), "gain for the RF chain")
        ...
        ("wave-freq", po::value<double>(&wave_freq)->default_value(5.0e3), "waveform frequency in Hz")
